package si.ape.parcel.api.v1.resources;
...
import si.ape.parcel.services.beans.ImageMetadataBean;
...
public class ImageMetadataResource {
    ...
    public Response getImageMetadata(@Parameter(description = "Metadata ID.", required = true)
        ...
        log.log(Level.INFO, "User accessed image in development, parcel service!");
